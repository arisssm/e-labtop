                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                placeholder="Contoh : 08xxxxxxxxxx" v-model="pesanan.nomor_telepon">
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-sm-4 col">
                        ...
                        <div class="dropdown my-3">
                            <select class="form-select" v-model="pesanan.bank" id="bank">
                                <option selected>--Pilih Satu--</option>
                                <option value="{{ item.id }}" v-for="item in bank" :key="item.id" >{{ item.nama }}</option>
                            </select>
                    ...
                    <div class="col-sm-3 col">
                        ...
                        <div class="dropdown my-3">
                            <select class="form-select" v-model="pesanan.pengiriman" id="pengiriman">
                                <option selected>--Pilih Satu--</option>
                                <option value="{{ item.id }}" v-for="item in pengiriman" :key="item.id" >{{ item.nama }}</option>
                            </select>
                        </div>
...
export default {
    ...
    methods: {
        getPengiriman(){
            axios
            .get('http://127.0.0.1:8000/api/pengiriman')
            .then((response) => {
                this.pengiriman = response.data.data;
                // console.log(this.pengiriman);//debug
