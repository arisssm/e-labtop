                            ...
                            <tbody class="">
                                <tr v-for="item in keranjang" :key="item.id">
                                    ...
                                    <td class="py-5 text-center text-custom">
                                        <button class="btn btn-sm btn-danger rounded" v-on:click=kurang(item)>
                                            <i class="fa fa-minus-circle"></i>
                                        </button>
                                        <span class="mx-3">{{ item.banyak }}</span>
                                        <button class="btn btn-sm btn-success rounded" v-on:click=tambah(item)>
    ...
    methods: {
        ...
        hapus(id) {
            axios
                ...
                .catch((error) => {
                    alert('Gagal menghapus keranjang' + error);
                    //console.log(error);
                })
        },
    }
